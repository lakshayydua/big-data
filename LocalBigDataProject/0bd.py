...
itr=0
for j in ['42401']:#,'42401',-------'42101','42602'--------]:44201
    train_final={}
    ...
    train_final[itr].coalesce(1).write.csv('/home/ldua/Desktop/BigDataProject/OutputLocal37/' + str(j), sep=',', header=True)

    #table_name = "g"+str(j)
    #rdd = train_final[itr].rdd.map(tuple)
    #words = rdd.map(load_table)
    #words.coalesce(1).write.csv('/home/ldua/Desktop/BigDataProject/OutputLocal37/' + str(j), sep=',', header=True)
    #words.coalesce(1).saveAsTextFile('/    home/ldua/Desktop/BigDataProject/OutputLocal37/' + str(j))

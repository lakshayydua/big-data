...
def load_table(words):
   ...
   dict_data['predicted_wind'] = float(words[3])
   return dict_data
...
for criteria_gas in ['44201']:#,'42401','42101','42602']:
    ...
    for i in stateval:
        ...
        df = training.select('month','year','am_wind').where((training['state_code'] == i["state_code"]))
...
for i in range(len(code)):
   ...
   if i == 0:
       pred_f = pred
       pred_f = pred_f.select(pred['state_code'], pred['year'], pred['month'], pred['predicted_wind'])
       continue
